...
export const JUNIOR_GRADING_SYSTEM = {
  ...
  grades: [
    { min: 75, max: 100, grade: '1', status: 'DISTINCTION', color: 'green', description: 'Exceptional performance' },
    { min: 60, max: 74, grade: '2', status: 'MERIT', color: 'blue', description: 'High performance' },
    { min: 50, max: 59, grade: '3', status: 'CREDIT', color: 'purple', description: 'Good performance' },
    { min: 40, max: 49, grade: '4', status: 'PASS', color: 'yellow', description: 'Satisfactory performance' },
    { min: 0, max: 39, grade: 'F', status: 'FAIL', color: 'red', description: 'Below satisfactory' },
  ],
...
export function getGradingSystem(gradeLevel) {
  const juniorLevels = ['form1', 'form2', 'grade9', 'grade 8', 'grade 9']
  const seniorLevels = ['form3', 'form4', 'form5', 'form6', 'grade10', 'grade11', 'grade12', 'grade 10', 'grade 11', 'grade 12']
