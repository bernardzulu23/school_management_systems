...
export const CURRICULUM_FEATURE_CATALOG = [
  ...
  {
    id: 'sms-parent-alerts',
    title: 'SMS alerts to parents',
    body: 'Notify parents by SMS about attendance and grades — keep families informed without needing a portal login.',
    href: '/dashboard/sms',
    minPlan: 'basic',
    pills: ['Attendance', 'Grades', 'SMS'],
  },
]
...
export const FEATURE_LOGIN_REDIRECTS = {
  ...
  'sms-parent-alerts': '/dashboard/sms',
}
