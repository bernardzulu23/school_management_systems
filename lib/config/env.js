...
export const env = {
  ...
  // SMS (AFRICASTALKING_* preferred; AFRICAS_TALKING_* accepted as alias)
  atApiKey: process.env.AFRICASTALKING_API_KEY || process.env.AFRICAS_TALKING_API_KEY,
  atUsername: process.env.AFRICASTALKING_USERNAME || process.env.AFRICAS_TALKING_USERNAME,
