...
const OPTIONAL = {
  ...
  AFRICASTALKING_API_KEY: "Africa's Talking API key — SMS fallback when Mocean unset",
  AFRICASTALKING_USERNAME: "Africa's Talking username",
  MOCEAN_API_TOKEN: 'Mocean API Bearer token — primary SMS provider when set',
  MOCEAN_SENDER_ID: 'Optional Mocean sender ID for school-context SMS',
