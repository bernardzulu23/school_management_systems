...
export async function removeSyncedTeacherAllocations(tx, schoolId, departmentAllocationId) {
  const notesTag = departmentAllocationNotesTag(departmentAllocationId)
  return tx.teacherAllocation.deleteMany({
...
export async function resyncApprovedDepartmentAllocation(tx, params) {
  ...
  await removeSyncedTeacherAllocations(tx, schoolId, allocation.id)
...
export async function deleteDepartmentAllocationCascade(tx, schoolId, allocationId) {
  await removeSyncedTeacherAllocations(tx, schoolId, allocationId)
