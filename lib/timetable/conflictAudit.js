...
import { buildClassDoubleBookedMessage } from '@/lib/timetable/timeRangeOverlap'
...
export async function auditDraftTimetable(prisma, { schoolId, term, academicYear }) {
  ...
  try {
    ...
    teacherClassSessionRules = parseSchedulingRulesJson(
      normalizeTimetableConfig(cfg).schedulingRules
    )
  } catch (err) {
