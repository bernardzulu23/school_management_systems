 ...
 * @param {{ term?: string, academicYear?: string, includeStudents?: boolean }} [opts]
 */
export async function collectUsedClassIds(prisma, schoolId, opts = {}) {
  ...
  const includeStudents = opts.includeStudents !== false
 ...
 * @param {import('@prisma/client').PrismaClient} prisma
 * @param {string} schoolId
 * @param {{ term?: string, academicYear?: string }} [opts]
 */
