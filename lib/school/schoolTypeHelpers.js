...
export function isSecondaryOnly(school) {
  if (typeof school?.hasPrimary === 'boolean' && typeof school?.hasSecondary === 'boolean') {
    return school.hasSecondary === true && school.hasPrimary === false
  }
  if (!hasKnownSchoolLevel(school)) return false
...
export function isCombined(school) {
  if (typeof school?.hasPrimary === 'boolean' && typeof school?.hasSecondary === 'boolean') {
    return school.hasPrimary === true && school.hasSecondary === true
  }
  if (!hasKnownSchoolLevel(school)) return false
...
export function hasSecondaryClasses(school) {
  if (typeof school?.hasSecondary === 'boolean') return school.hasSecondary
  if (!hasKnownSchoolLevel(school)) return false
...
export function hasPrimaryClasses(school) {
  if (typeof school?.hasPrimary === 'boolean') return school.hasPrimary
  if (!hasKnownSchoolLevel(school)) return false
