...
export const HOD_FILE_ENTITY_TYPES = new Set([
  ...
  'stock',
  'weekly_routine',
  // Document cabinets for File Management modules (entityId = departmentId or "school")
  'exam_analysis',
  'monitoring',
])
...
/** Stable cabinet id for HOD document libraries (no parent row required). */
export function hodCabinetEntityId(departmentId) {
  return departmentId ? String(departmentId) : 'school'
}

export function isHodDocumentCabinet(entityType) {
  return entityType === 'exam_analysis' || entityType === 'monitoring'
}
