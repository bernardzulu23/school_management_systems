...
/** Higher temp so regenerating the same topic yields different cards. */
export const FLASHCARD_TEMPERATURE = 0.7
...
{"title":"deck title","cards":[{"front":"question text","options":["Transpiration","Respiration","Photosynthesis","Osmosis"],"answer":"Transpiration","explanation":"one line"}]}`
