...
import { emitOfflineQueue } from '@/lib/offline/events'
import { isNetworkFailure as detectNetworkFailure } from '@/lib/offline/network'

const GRADEBOOK_KEEP_MS = 8 * 24 * 60 * 60 * 1000
const LEGACY_GRADEBOOK_PREFIX = 'gradebook_queue_v1'

function isNetworkFailure(err) {
  return detectNetworkFailure(err)
}
