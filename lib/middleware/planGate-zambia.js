...
export async function requireFeature(schoolId, featureId, options = {}) {
  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          message: 'AI features are disabled until the school activation fee is paid.',
    ...
    const individualFreePlans = ['individual_free', 'student_free']
    ...
    const isPlanExpired =
      !onTrial &&
      !individualFreePlans.includes(plan) &&
      plan !== 'trial' &&
