...
class OfflineStorageManager {
  ...
  async syncAction(item) {
    ...
    switch (action) {
      ...
      case 'CREATE_ACHIEVEMENT':
        // Gamification badges sync via student game completion API; legacy route removed.
        console.warn('CREATE_ACHIEVEMENT offline sync skipped — use game completion API')
        break
   ...
   */
  isDataFresh(data, maxAge = 3600000) {
    // 1 hour default
