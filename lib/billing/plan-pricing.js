...
export const PLAN_DESCRIPTIONS = {
  ...
  standard: 'Up to 1,000 students · Analytics + SMS',
  premium: 'Unlimited · All features + priority support',
  individual: 'Solo teacher · Up to 10 students · ECZ tools · 3-month trial · K50/month after',
  individual_free: 'Solo teacher · Up to 10 students · ECZ tools · 3-month trial · K50/month after',
...
/** @deprecated No plan skips subscription — all roles get a 3-month trial then must pay. */
export const FREE_INDIVIDUAL_PLANS = new Set([])

/** Plans that unlock AI generation features (Basic has no AI per Pricing). */
export const AI_PLANS = ['individual_premium', 'individual_annual', 'standard', 'premium', 'trial']
