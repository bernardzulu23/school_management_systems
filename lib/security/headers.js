...
const ALLOWED_ORIGIN_SUFFIXES = parseList(
  process.env.ALLOWED_ORIGIN_SUFFIXES || '.bluepeacktechnologies.com,.railway.app,.onrender.com'
)
...
export function buildContentSecurityPolicy() {
  ...
  const directives = [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://*.railway.app https://*.onrender.com",
...
export function getCorsHeaders(request) {
  ...
  return {
    ...
    'Access-Control-Allow-Headers':
      'Content-Type, Authorization, X-Requested-With, X-School-Subdomain, x-school-id, x-school-subdomain',
