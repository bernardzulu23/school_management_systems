...
export async function buildEmisWorkbook(schoolId, year = new Date().getFullYear()) {
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(profileRows), 'School Profile')
  XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(enrolmentRows), 'Enrolment')
