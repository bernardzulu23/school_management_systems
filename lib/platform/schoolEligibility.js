...
/** Metadata-only shape — no student/teacher PII, counts, or academic records. */
export function toPlatformSchoolSummary(school) {
  return {
    id: school.id,
    name: school.name,
    ...
    reportingStreamKey: school.reportingStreamKey || null,
    ...
    creatorName: school.creatorName || null,
    creatorPhone: school.creatorPhone || school.phone || null,
    creatorEmail: school.creatorEmail || school.email || null,
  }
}
