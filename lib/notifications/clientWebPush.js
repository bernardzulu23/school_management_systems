...
/**
 * Subscribe and persist endpoint on the server.
 *
 * Calls Notification.requestPermission() ONLY when permission is still
 * "default". Callers must invoke this from a user gesture (button click)
 * when permission has not already been granted — never from useEffect/mount.
 *
...
export async function subscribeToWebPush() {
  ...
  if (permission === 'default') {
    // Must be user-gesture initiated; do not call from mount/auto-enable paths.
