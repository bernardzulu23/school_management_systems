...
export const TYPE_DEFAULT_CHANNELS = {
  CLASS_REMINDER: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
  DEPARTMENT_MEETING_REMINDER: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
  TEST_SCHEDULED: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
  TEST_DATE_REMINDER: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
  MISSED_TEST_ALERT: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL', 'SMS'],
  SCHEME_PROGRESS: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
  LOW_MASTERY_ALERT: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
  LESSON_ASSIGNED: ['WEB_PUSH', 'EXPO_PUSH', 'EMAIL'],
}
