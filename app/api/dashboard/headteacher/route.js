    ...
    const studentsRequiringAttention = Array.from(byStudent.entries())
      .map(([sid, rows]) => {
        ...
        return {
          ...
          parent_father_email: s?.parent_father_email || '',
          parent_mother_contact: s?.parent_mother_contact || '',
          parent_mother_name: s?.parent_mother_name || '',
          parent_mother_email: s?.parent_mother_email || '',
