  ...
  return (
    <div className="min-h-screen flex flex-col font-sans">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=2187&auto=format&fit=crop')` 
          // Using a professional blue-toned business/tech background image
        }}
      >
        {/* Navbar */}
