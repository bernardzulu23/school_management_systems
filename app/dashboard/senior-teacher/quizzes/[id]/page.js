...
export default function SeniorTeacherQuizReviewPage() {
  ...
  async function review(action) {
    ...
    try {
      ...
      setMeta((current) => ({ ...current, ...json.data }))
      toast.success(action === 'approve' ? 'Approved and sent to students' : 'Feedback sent')
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <DashboardLayout title="Review Quiz">
      <div className="space-y-4">
        <Link href="/dashboard/senior-teacher/quizzes">
        ...
        {loading ? (
          ...
          <>
            <Card>
              ...
              <CardContent className="text-sm text-royalPurple-text2 space-y-1">
                ...
                <div className="text-royalPurple-text1">
                  Full preview with answers for Senior Teacher review.
                </div>
              </CardContent>
            </Card>
            ...
            {canReview ? (
              <Card>
                <CardHeader>
                  <CardTitle>Senior Teacher decision</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <textarea
