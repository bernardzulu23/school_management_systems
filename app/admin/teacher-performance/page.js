...
export default function TeacherPerformancePage() {
  ...
  if (loading && !selectedTeacher) {
    return (
      <main className="container mx-auto px-4 py-6" role="main" aria-busy="true" aria-label="Loading teacher performance system">
        <div className="mb-6">
    ...
    <main className="container mx-auto px-4 py-6" role="main">
      ...
      {selectedTeacher && (
        <div className="border-b border-gray-200 mb-6">
          <nav className="-mb-px flex space-x-8" role="tablist" aria-label="Teacher performance sections">
            {[
      ...
      <section aria-label="Performance content">
        {!selectedTeacher ? (
          ...
          <div className="space-y-6">
            ...
            {/* Teachers Grid */}
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" role="list" aria-label="Teachers list">
                  ...
                  <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer group focus-within:ring-2 focus-within:ring-blue-500">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">{teacher.name}</h3>
