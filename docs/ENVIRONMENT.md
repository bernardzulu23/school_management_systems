...
| `VERCEL_PROJECT_ID`                                   | Vercel project id for Analytics queries         | Defaults to production `prj_9fHza1PlabDZJuxYCoGBGOH9IaIq` when unset                                                                                                                                                                                                                                             |
| `VERCEL_TEAM_ID`                                      | Vercel team id for Analytics queries            | Defaults to `team_KowipjQTzEoEVBFNWM8vqxDA` when unset                                                                                                                                                                                                                                                           |
