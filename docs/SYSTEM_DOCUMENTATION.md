...
| **Results & reports** | End-of-term, midterm, and class-test results; headteacher/HOD views exclude class tests; headteacher dashboard supports result-type filter | `lib/results/resultTypes.js`, `app/api/teacher/results/`, `app/api/dashboard/results/`, `app/api/dashboard/headteacher/` |
