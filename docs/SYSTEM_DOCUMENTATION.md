...
| Operations         | `LessonPlan`, `TermReport`, `SmsBroadcast`, `SchoolPlanPayment`, `SchoolFeePayment`, `FeeSchedule`, `StudentInvoice`, `FeePayment`, `SiblingGroup`, `SchoolRegistration`, `AIRequest`, `AiCache` (SHA-256 payload hash + featureKey for AI response reuse) |
