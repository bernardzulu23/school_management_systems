...
export const HeadteacherOverview = memo(function HeadteacherOverview() {
  ...
  return (
    <div className="space-y-8">
      <Card className="border-royalPurple-border/40 bg-royalPurple-muted/40">
        <CardContent className="p-5 flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div>
              <h2 className="font-bold text-royalPurple-text1">Analytics Assistant</h2>
              <p className="text-sm text-royalPurple-text2 mt-0.5">
                Ask about enrollment, attendance, exam performance, and teacher coverage
                (retrieval-only answers from verified figures).
              </p>
            </div>
          </div>
          <Link
            href="/dashboard/headteacher/chat"
            className="inline-flex items-center justify-center rounded-lg bg-royalPurple-accent px-4 py-2 text-sm font-semibold text-royalPurple-deep hover:opacity-90 shrink-0"
          >
            Open assistant
          </Link>
        </CardContent>
