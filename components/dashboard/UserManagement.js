...
import { 
  ...
  Plus, Edit, Trash2, Search, Filter, Eye, RefreshCcw 
} from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      <main className="space-y-8">
        ...
        {/* Management Actions */}
        <section aria-label="Registration actions" className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <CardContent>
              <div className="backdrop-blur-sm bg-slate-800/60 border border-slate-600/40 rounded-2xl p-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                  ...
                  <Button variant="outline" className="border-slate-400 text-slate-300 hover:bg-slate-600/20" aria-label="Open filters">
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {isLoading ? (
                        ...
                        <tr>
                          <td colSpan="5" className="py-12">
                            <div className="flex flex-col items-center justify-center space-y-4" aria-live="assertive">
