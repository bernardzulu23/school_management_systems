            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-royalPurple-text2">
                  Expected GPA:{' '}
                  <span className="font-bold text-royalPurple-accent">
    ...
    <div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4 text-center">
          <div>
            <p className="text-2xl font-bold text-royalPurple-accent">{data?.totalPoints || 0}</p>
  ...
  <div>
    ...
    <div className="space-y-3">
      <div className="bg-royalPurple-accent rounded-lg p-3">
        <h4 className="font-medium text-royalPurple-accent">{paths?.subject || 'Mathematics'}</h4>
      ...
      <button className="w-full text-royalPurple-accent text-sm hover:text-royalPurple-accent transition-colors">
        View All Paths →
      </button>
    </div>
  </div>
  ...
  <div>
    ...
    <div className="space-y-3">
      ...
      <div>
        ...
        <p className="text-xl font-bold text-royalPurple-accent">
