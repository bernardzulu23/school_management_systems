  ...
  return (
    <Card className="max-w-2xl mx-auto p-6">
      <div className="flex items-start gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-royalPurple-text2 mt-1">
            Import up to 1,000 students from the official ZSMS Excel template. Subjects are matched
            to your school&apos;s subject catalog by name.
          </p>
        </div>
      </div>
      ...
      <a
        ...
        className="inline-flex items-center gap-2 mb-4 text-sm font-medium text-royalPurple-accentTx hover:underline"
      >
        <Download className="w-4 h-4" aria-hidden />
        Download ZSMS Upload Template
      </a>
