...
const EnhancedDashboardIntegration = ({ userRole, userId, userName }) => {
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card wellbeing">
          ...
          <div className="stat-content">
            ...
            <div className="stat-detail">{crossPhaseData.wellbeing?.riskLevel} risk level</div>
          </div>
        </div>
          ...
          {notifications.slice(0, 5).map((notification) => (
            ...
            >
              ...
              <div className="activity-content">
                ...
                <span className="activity-time">{notification.timestamp.toLocaleTimeString()}</span>
              </div>
  ...
  return (
    <div className="enhanced-dashboard-integration">
      ...
      <div className="main-content">{renderCurrentView()}</div>
