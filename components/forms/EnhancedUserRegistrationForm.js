...
export default function EnhancedUserRegistrationForm({ role = 'student', onSubmit, onCancel }) {
  ...
  return (
    <div className="max-w-4xl mx-auto form-card border border-royalPurple-border rounded-2xl shadow-xl overflow-hidden">
      {/* Header */}
      <div className="form-card border-b border-royalPurple-border p-8 text-royalPurple-text1">
