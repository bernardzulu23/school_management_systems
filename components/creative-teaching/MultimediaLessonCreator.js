...
export default function MultimediaLessonCreator() {
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-slate-800/60 border-slate-700/40" as="section" aria-labelledby="lesson-creator-title">
        <CardHeader>
          <CardTitle id="lesson-creator-title" className="text-white flex items-center justify-between">
            <div className="flex items-center">
              <Video className="h-5 w-5 mr-2 text-purple-400" aria-hidden="true" />
