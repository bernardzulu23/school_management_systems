...
import { BookOpen, Users, Target, TrendingUp, CheckCircle, Clock, Award, Globe } from 'lucide-react'
...
export default function TeacherSDGView({ teacherId, classData = [], studentData = [] }) {
  ...
  const calculateClassroomSDGProgress = (sdgId, classes, students) => {
    ...
    switch (sdgId) {
      case 1: // No Poverty
        const studentsWithSupport = students.filter(
          (s) => s.hasScholarship || s.receivesSupport
        ).length
      ...
      case 2: // Zero Hunger
        ...
        return students.length > 0
          ? Math.round((studentsReceivingMeals / students.length) * 100)
          : 0
    ...
    setCurriculumAlignment([
      {
        ...
        sdgAlignment: [4, 8, 9],
        activities: [
          'Problem-solving for economic growth',
  ...
  const getClassroomOverallProgress = () => {
    const totalProgress = Object.values(classroomSDGProgress).reduce(
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="border-l-4 border-l-green-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-royalPurple-text3">Active projects</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-purple-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-royalPurple-text3">Subjects integrated</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-orange-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-royalPurple-text3">Overall contribution</p>
          </CardContent>
        </Card>
      </div>
            ...
            {curriculumAlignment.map((subject, index) => (
              <div key={index} className="p-4 border rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="font-semibold text-royalPurple-text1">{subject.subject}</h3>
                ...
                <div className="mt-2 w-full bg-royalPurple-card2 rounded-full h-2">
                  <div
            ...
            {studentSDGActivities.map((activity) => (
              <div key={activity.id} className="p-4 border rounded-lg">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-semibold text-royalPurple-text1">{activity.title}</h3>
                  <span
